...
document.getElementById('colorblindMode').addEventListener('change', function () {
  document.body.className = document.body.className.replace(/deuteranopia|protanopia|tritanopia/g, '');
  if (this.value) {
...
function readSection(section) {
  ...
  switch (section) {
    case 'header':
      ...
      break;
    case 'features':
      textToRead = Array.from(document.querySelectorAll('.card-text')).map(el => el.textContent).join('. ');
      break;
    default:
...
document.getElementById('dyslexicFont').addEventListener('change', savePreferences);
document.getElementById('highContrast').addEventListener('change', savePreferences);
document.getElementById('simplifiedLayout').addEventListener('change', savePreferences);
document.getElementById('colorblindMode').addEventListener('change', savePreferences);
